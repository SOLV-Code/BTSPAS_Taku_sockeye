# 2019-04-29 Added check for n1=0 but ones added. Changed the n1=0 to n1=1.
# 2019-04-24 Added the "add.ones.at.start" flat to fit.BTSPAS and fit.BTSPAS.dropout functions.
