...
You may need to type in '3' even though this choice is 'NONE.' Need to talk to Carl about possible glitch.
...
The weekly inseason estimate should be the mean estimate from the file/folder '*Taku-FullWeek-Inseason-Wxx-Wxx-fallback--yyyy*'*
output to the file 'Taku-Inseason-W*xx*-W*xx*--*yyyy*Inseason-run.size.csv.  
